(function($, window, document, undefined) {
    ...
    var pluginName = "floatingSocialShare",
        defaults = {
            place: "top-left",
            counter: true,
            buttons: ["facebook", "twitter", "google-plus", "VK"],
    ...
    var places = ["top-left", "top-right"],
        networks = {
            ...
            "facebook" : {
                className: "facebook",
                url:"https://www.facebook.com/sharer/sharer.php?u={MixtourEventOfficiel/?fref=ts}&t={title}"


            },
            "google-plus": {
                className: "google-plus",
                url: "https://plus.google.com/share?"url={"https://www.facebook.com/beatsleopard"}
            },
            "linkedin": {
                className: "linkedin",
